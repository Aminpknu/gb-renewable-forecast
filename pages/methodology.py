                        ...
                        [
                            ...
                            html.Ul(
                                [
                                    ...
                                    html.Li("Training, validation and test periods are chronological; there is no random split."),
                                    html.Li("Models are selected on validation data; final metrics use untouched test data."),
                                    html.Li("Monthly climatology remains as the baseline comparison."),
                                    html.Li("Five unavailable target dates—6 to 10 August 2025—are documented rather than filled."),
                            ...
                            html.Dl([html.Dt("Training"), html.Dd("1 Apr 2024 – 31 Mar 2025"), html.Dt("Validation"), html.Dd("1 Apr 2025 – 31 May 2025"), html.Dt("Test"), html.Dd("1 Jun 2025 – 31 Aug 2025")], className="method-definitions compact-splits"),
                        ],
                        ...
                        [
                            ...
                            html.Ul(
                                [
                                    ...
                                    html.Li("The complete automated suite contains 94 validated offline tests."),
                                ],
